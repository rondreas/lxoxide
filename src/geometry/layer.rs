...
impl BinRead for DiscontinousVertexMap {
    ...
    fn read_options<R: Read + Seek>(
        ...
        Ok(DiscontinousVertexMap { kind, dimension, name, data })
    }
}
...
mod tests {
    ...
    fn cube_discontinous_vertex_map() {
        let mut reader = Cursor::new([
            0x56, 0x4d, 0x41, 0x44, 0x00, 0x00, 0x00, 0x62, 0x54, 0x58, 0x55, 0x56,
            0x00, 0x02, 0x54, 0x65, 0x78, 0x74, 0x75, 0x72, 0x65, 0x00, 0x00, 0x01,
            0x00, 0x01, 0x3f, 0x40, 0x00, 0x00, 0x3e, 0xaa, 0xaa, 0xab, 0x00, 0x00,
            0x00, 0x01, 0x3f, 0x80, 0x00, 0x00, 0x3e, 0xaa, 0xaa, 0xab, 0x00, 0x01,
            0x00, 0x02, 0x3f, 0x40, 0x00, 0x00, 0x3e, 0xaa, 0xaa, 0xab, 0x00, 0x04,
            0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x3f, 0x2a, 0xaa, 0xab, 0x00, 0x00,
            0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x3e, 0xaa, 0xaa, 0xab, 0x00, 0x04,
            0x00, 0x05, 0x3e, 0x80, 0x00, 0x00, 0x3f, 0x80, 0x00, 0x00, 0x00, 0x05,
            0x00, 0x05, 0x3f, 0x00, 0x00, 0x00, 0x3f, 0x80, 0x00, 0x00
        ]);
